...
polygon_sides = COLOR([0.68,0.57,0.4])(STRUCT(polylines_sides))
...
polygon_octagons = COLOR([0.68,0.57,0.4])(STRUCT(polylines_octagons))
...
polygon_internal_structure_empty = DIFFERENCE([polygon_internal_structure,polygon_internal_octagon_SOLIDIFY])first_floor_thick = PROD([((polygon_internal_structure_empty)),Q(3)])first_floor_color = COLOR([0.42,0.38,0.3])(first_floor_thick)relived_first_floor = T(3)(23)(first_floor_color)top = COLOR([0.68,0.57,0.4])(T(3)(52)(polygon_internal_structure))bottom = COLOR([0.68,0.57,0.4])(polygon_internal_structure)
...
piano_terra = STRUCT([complete_base_structure_2D,bottom])
...
octagon_1 = (AA(POLYLINE)([octagon_1]))octagon_2 = (AA(POLYLINE)([octagon_2]))octagon_3 = (AA(POLYLINE)([octagon_3]))octagon_4 = (AA(POLYLINE)([octagon_4]))octagon_5 = (AA(POLYLINE)([octagon_5]))octagon_6 = (AA(POLYLINE)([octagon_6]))octagon_7 = (AA(POLYLINE)([octagon_7]))octagon_8 = (AA(POLYLINE)([octagon_8]))o1 = (STRUCT(octagon_1))o2 = (STRUCT(octagon_2))o3 = (STRUCT(octagon_3))o4 = (STRUCT(octagon_4))o5 = (STRUCT(octagon_5))o6 = (STRUCT(octagon_6))o7 = (STRUCT(octagon_7))o8 = (STRUCT(octagon_8))only_top = STRUCT([o1,o2,o3,o4,o5,o6,o7,o8])only_top_SOLIDIFY = SOLIDIFY(only_top)torri = STRUCT([only_top_SOLIDIFY])torri_alzate = COLOR([0.68,0.57,0.4])(T(3)(53)(torri))
muri_e_torri = STRUCT([polygon_sides,polygon_octagons])

prod = PROD([muri_e_torri,Q(25)])
muri_e_torri2 = COLOR([0.68,0.57,0.4])(prod)

structure_2D = COLOR([0.42,0.38,0.3])(DIFFERENCE([complete_base_structure_SOLIDIFY,   polygon_internal_octagon_SOLIDIFY]))
structure_2D_alta = T(3)(25)(piano_terra)

muri_e_torri_secondo_piano = T(3)(28)(muri_e_torri2)

window_8 = CUBOID([0,3,5])window_8_T = COLOR([0.63,1,1])(T([1,2,3])([14,58,28])(window_8))window_4 = CUBOID([0,3,5])window_4_T = COLOR([0.63,1,1])(T([1,2,3])([108,59,28])(window_4))window_6 = CUBOID([3,0,5])window_6_T = COLOR([0.63,1,1])(T([1,2,3])([59.5,108,28])(window_6))window_over_door = COLOR([0.63,1,1])(CUBOID([3,0,5]))window_over_door = T([1,2,3])([59.5,14,28])(window_over_door)door = CUBOID([6,0,10])door2 = T([1,2])([58,14])(door)window_8_sub = CUBOID([0,3,5])window_8_T_sub = COLOR([0.63,1,1])(T([1,2,3])([14,58,12])(window_8_sub))window_4_sub = CUBOID([0,3,5])window_4_T_sub = COLOR([0.63,1,1])(T([1,2,3])([102,59,12])(window_4_sub))window_6_sub = CUBOID([3,0,5])window_6_T_sub = COLOR([0.63,1,1])(T([1,2,3])([59.5,102,1])(window_6_sub))_2D = STRUCT([piano_terra,structure_2D_alta,torri_alzate,muri_e_torri2,muri_e_torri_secondo_piano,window_8,window_8_T,window_4,window_4_T,window_6,window_6_T, window_over_door,door2,window_8_T_sub,window_4_T_sub,window_6_T_sub])
