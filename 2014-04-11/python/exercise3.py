...
################# BASAMENTO:rettangolo_base = [[-250,-230],[-200,350],[400,350],[400,-230],[-250,-230]]polylines_rettangolo_base = (AA(POLYLINE)([rettangolo_base]))
polygon_rettangolo_base = SOLIDIFY(STRUCT(polylines_rettangolo_base))polygon_rettangolo_base = COLOR([0.09803921568,0.54509803921,0.0862745098])(polygon_rettangolo_base)struttura_con_campo = STRUCT([polygon_rettangolo_base,structure_complete])capannone = CUBOID([30,40,30])capannone2 = CUBOID([20,30,20])
vertsT = [[0,0],[15,5],[30,0]]
cellsT = [[1,2,3]]
polsT = None
tri = MKPOL([vertsT, cellsT, polsT])
tri3D = PROD([tri,Q(40)])
tri3Drot = R([2,3])(PI/2)(tri3D)
tri3Drot = T([2,3])([40,30])(tri3Drot)
vertsT2 = [[0,0],[10,5],[20,0]]
cellsT2 = [[1,2,3]]
polsT2 = None
tri2 = MKPOL([vertsT2, cellsT2, polsT2])
tri3D_2 = PROD([tri2,Q(40)])
tri3Drot_2 = R([2,3])(PI/2)(tri3D_2)
tri3Drot_2 = T([2,3])([35,20])(tri3Drot_2)
capannone_completo = STRUCT([COLOR([0.52549019607,0.52549019607,0.52549019607])(capannone),COLOR([0.34117647058,0.34117647058,0.34117647058])(tri3Drot)])capannone_completo = T([1,2])([200,-150])(capannone_completo)capannone_completo_2 = STRUCT([COLOR([0.52549019607,0.52549019607,0.52549019607])(capannone2),COLOR([0.34117647058,0.34117647058,0.34117647058])(tri3Drot_2)])capannone_completo_2 = T([1,2])([300,-150])(capannone_completo_2)torretta = CIRCLE(10)([8,5])torretta = PROD([torretta, Q(35)])cono = CONE([12,7])(8)cono = T(3)(35)(cono)torretta = STRUCT([COLOR([0.88235294117,0.6862745098,0.34509803921])(torretta), COLOR([0.99215686274,0.49803921568,0.13725490196])(cono)])torretta = T([1,2])([280,-180])(torretta)VIEW(STRUCT([struttura_con_campo,capannone_completo,capannone_completo_2,torretta]))